...
const JobTitle = () => {
  return (
    <div className="border-b">
      <div className="pl-4 md:pl-10  flex flex-col gap-4 my-4">
        <div className=" flex items-center gap-4 flex-wrap">
          <h1 className="text-2xl md:text-4xl font-bold text-[#3D3D3D]">
        ...
        <div className="flex gap-4 items-center">
          <div className="flex gap-2 items-center">
            ...
            <span className="text-[#5D5D5D] md:text-xl">Delaware, USA</span>
          </div>
          ...
          <div className="flex gap-2 items-center">
            ...
            <span className="text-[#5D5D5D] md:text-xl">$300k-$400k</span>
          </div>
        </div>
      </div>
    </div>
